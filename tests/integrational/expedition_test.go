...
func TestPgExpeditionService_GetLeaderExpeditions(t *testing.T) {
	type args struct {
		ctx      context.Context
		client   any
		leaderId int
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			got, err := tc.s.GetLeaderExpeditions(tc.args.ctx, tc.args.client, tc.args.leaderId)
			if tc.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestPgExpeditionService_GetMemberExpeditions(t *testing.T) {
	type args struct {
		ctx      context.Context
		client   any
		memberId int
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			got, err := tc.s.GetLeaderExpeditions(tc.args.ctx, tc.args.client, tc.args.memberId)
			if tc.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestPgExpeditionService_GetCuratorExpeditions(t *testing.T) {
	type args struct {
		ctx       context.Context
		client    any
		curatorId int
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			got, err := tc.s.GetLeaderExpeditions(tc.args.ctx, tc.args.client, tc.args.curatorId)
			if tc.wantErr {
				assert.Error(t, err)
				return
			}
