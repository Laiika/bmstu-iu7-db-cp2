...
// GetEquipmentById mocks base method.
func (m *MockEquipmentRepo) GetEquipmentById(arg0 context.Context, arg1 interface{}, arg2 int) (*entity.Equipment, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEquipmentById", arg0, arg1, arg2)
	ret0, _ := ret[0].(*entity.Equipment)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetEquipmentById indicates an expected call of GetEquipmentById.
func (mr *MockEquipmentRepoMockRecorder) GetEquipmentById(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetEquipmentById", reflect.TypeOf((*MockEquipmentRepo)(nil).GetEquipmentById), arg0, arg1, arg2)
}
