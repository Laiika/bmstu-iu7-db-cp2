...
func (s *LocationService) GetLocationById(ctx context.Context, client any, id int) (*entity.Location, error) {
	location, err := s.locationRepo.GetLocationById(ctx, client, id)
	if err != nil {
