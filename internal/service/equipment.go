...
func (s *EquipmentService) GetEquipmentById(ctx context.Context, client any, id int) (*entity.Equipment, error) {
	equipment, err := s.equipmentRepo.GetEquipmentById(ctx, client, id)
	if err != nil {
