...
func (r *LeaderRepo) GetLeaderById(ctx context.Context, client any, id int) (*entity.Leader, error) {
	...
	`
	var l entity.Leader
	err := pgClient.QueryRow(ctx, q, id).Scan(&l.Id, &l.Name, &l.PhoneNumber, &l.Login, &l.Password)
